...
<?php
    ...
    if(isset($_POST['name'])){
        ...
        if(mysqli_num_rows($result)==1){
            header('Location: registrationorg.php?userexists=true');
            exit();
        }
        
        $sql="INSERT INTO users (userid, password, name, usertype, email, phone, address, city, proof) VALUES ('$userid', '$password', '$name', '2', '$email', '$phone', '$address', '$city', '$proof')";
